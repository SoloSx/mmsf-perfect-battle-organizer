...
export const MMSF3_PLAYER_NOISE_SELECT_OPTIONS: SearchableSelectOption[] = [
  { value: "ノーマルロックマン", label: "ノーマルロックマン" },
  ...MMSF3_PLAYER_NOISE_OPTIONS.map((option) => ({ value: option, label: option })),
];
